...
import { KakaoLogoutButton, ProgressBar, Tab, Template } from '@/components';
import { authOptions } from '@/lib/auth';
import { button } from '@/styles/ogoo';
import { flexCol, flexColCenter, flexRowCenter } from '@/styles/ogoo/alignment.css';
  ...
  return (
    <Template>
      <section className={cn(flexColCenter, `px-5 pb-32`)}>
        ...
        <footer
          className={cn(flexColCenter, `absolute bottom-28 left-0 right-0 px-5 pt-3 bg-white`)}
        >
